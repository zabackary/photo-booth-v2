    ...
    fn draw(
        ...
        let geometry = state.cache.draw(renderer, bounds.size(), |frame| {
            ...
            frame.fill(
                &canvas::Path::circle(
                    iced::Point {
                        x: frame.center().x + start_angle.0.cos() * track_radius,
                        y: frame.center().y + start_angle.0.sin() * track_radius,
                    },
                    self.bar_height / 2.0,
                ),
            ...
            frame.fill(
                &canvas::Path::circle(
                    iced::Point {
                        x: frame.center().x + end_angle.0.cos() * track_radius,
                        y: frame.center().y + end_angle.0.sin() * track_radius,
                    },
                    self.bar_height / 2.0,
                ),
                custom_style.bar_color,
